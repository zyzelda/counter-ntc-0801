...
/* Generated from ../O.Common/nct.dbd */
...
int nct_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/blctrl/BL09B1-NCT0801-SoftIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"nct_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    nct_registerRecordDeviceDriver(*iocshPpdbbase);
}
